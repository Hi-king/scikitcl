...
if __name__ == '__main__':
    ...
    probabilities_filename = base + cls_suffix + "_probabilities.csv"
    ...
    pred = scipy.dot(classifier.coef_, testdata.T)+classifier.intercept_
    print pred
    ...
    csv.writer(open(probabilities_filename, "w+")).writerows( map(lambda x: [x], pred.tolist()[0]) )
